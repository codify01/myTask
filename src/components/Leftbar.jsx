...
const LeftBar = () => {
    ...
    return (
        ...
        <div className="hidden md:flex flex-col justify-between bg-accent-white dark:bg-accent-black dark:text-accent-white w-1/5 h-[93vh] border-r border-neutral-400 dark:border-neutral-500 px-5 py-5">
            ...
            <div className="space-y-4 h-3/5">
                ...
                <ul className="text-lg overflow-y-scroll h-[85%] hover:shadow-accent-white space-y-4">
                    {
