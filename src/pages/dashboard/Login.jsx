...
const Login = () => {
    ...
    return (
        ...
        <div className="login-page sContainer flex justify-center items-center">
            {/* <div className="frm2 p-10"> */}
            <div className='border dark:border-neutral-500 border-neutral-400 p-10 rounded-md dark:bg-neutral-800 bg-neutral-200 space-y-10 w-[75%] bg max-w-[750px]'>
                ...
                <form action="" className="d-flex space-y-4 w-full flex-column">
                    <div>
                        <label for="email" class="block mb-2 text-sm text-gray-900 dark:text-white">Email Address</label>
